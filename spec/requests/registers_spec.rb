...
RSpec.describe "Registers", type: :request do
  describe "Post /signup" do
    it "returns 200 when params are valid" do
      post user_registration_path, params: { user: { email: "test@test.com", password: "123456", password_confirmation: "123456" } }
    ...
    it "returns 422 when params are invalid" do
      post user_registration_path, params: { user: { email: "test@test.com", password: "123456", password_confirmation: "1234567" } }
